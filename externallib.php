 ...
 * @since     Moodle 2.6
 */
class enrol_candidat_external extends external_api {
    ...
    public static function get_instance_info_parameters() {
        return new external_function_parameters(
                array('instanceid' => new external_value(PARAM_INT, 'instance id of candidat enrolment plugin.'))
            );
    }

    /**
     * Return candidat-enrolment instance information.
     *
     * @param int $instanceid instance id of candidat enrolment plugin.
    ...
    public static function get_instance_info($instanceid) {
        ...
        $params = candidat::validate_parameters(candidat::get_instance_info_parameters(), array('instanceid' => $instanceid));

        // Retrieve candidat enrolment plugin.
        $enrolplugin = enrol_get_plugin('candidat');
        ...
        candidat::validate_context($categorycontext);
