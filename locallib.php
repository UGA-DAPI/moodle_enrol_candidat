...
class enrol_candidat_enrol_form extends moodleform {
    protected $instance;
    ...
    public function definition() {
        ...
        if ($instance->password) {
            ...
            $mform->addElement('passwordunmask', 'enrolpassword', get_string('password', 'enrol_candidat'),
            ...
            foreach ($keyholders as $keyholder) {
                $keyholdercount++;
                if ($keyholdercount === 1) {
                    $mform->addElement('static', 'keyholder', '', get_string('keyholder', 'enrol_candidat'));
                }
            ...
            $mform->addElement('static', 'nokey', '', get_string('nopassword', 'enrol_candidat'));
        }

        $this->add_action_buttons(false, get_string('enrolme', 'enrol_candidat'));
            ...
            if ($data['enrolpassword'] !== $instance->password) {
                if ($instance->customint1) {
                    ...
                    if (!$found) {
                        ...
                        $errors['enrolpassword'] = get_string('passwordinvalid', 'enrol_candidat');
                    }
                    ...
                    if ($plugin->get_config('showhint')) {
                        ...
                        $errors['enrolpassword'] = get_string('passwordinvalidhint', 'enrol_candidat', $hint);
                    } else {
                        $errors['enrolpassword'] = get_string('passwordinvalid', 'enrol_candidat');
                    }
                }
